...
export const TUTORIALS_DATA: ProjectTutorial[] = [
  {
    ...
    thumbnail: "/thumbnails/blinking-led.png",
...
void loop() {
  ...
  },
  {
    ...
    thumbnail: "/thumbnails/potentiometer.png",
...
void loop() {
  ...
  },
  {
    ...
    thumbnail: "/thumbnails/led-patterns.png",
...
void loop() {
  ...
  },
  {
    ...
    thumbnail: "/thumbnails/rc-car.png",
